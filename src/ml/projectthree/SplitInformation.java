...
public class SplitInformation implements Comparable<SplitInformation>{
    private ColumnAttributes.ColumnType columnType;
    private Integer columnIndex;
    private Double value;
    private Double information;

    public SplitInformation(ColumnAttributes.ColumnType columnType, Integer columnIndex, Double value, Double information){
    ...
    @Override
    public int compareTo(SplitInformation o) {
